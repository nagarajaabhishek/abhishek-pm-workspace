...
// Extract Splitwise
const swMatch = data.match(/slug:\s*'splitwise-teardown'[\s\S]*?content:\s*`([\s\S]*?)`,\n\s*},/);
const swContent = swMatch ? swMatch[1] : '';
...
fs.mkdirSync('/Users/abhisheknagaraja/Documents/Tardis/abhishek-pm-workspace/app/content/splitwise-teardown', { recursive: true });
fs.writeFileSync('/Users/abhisheknagaraja/Documents/Tardis/abhishek-pm-workspace/app/content/splitwise-teardown/page.tsx', template("Splitwise Teardown", swContent, "2024"));
